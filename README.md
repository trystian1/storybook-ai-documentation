# Storybook Addon Component AI Documentation
This addon will provide you with documentation about the component displayed. So new users to your codebase can read how to use it
